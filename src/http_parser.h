...
enum http_method_e parse_req_method(http_request_t *p_http_request);
char* parse_req_path(http_request_t *p_http_request);
enum http_version_e parse_http_version(http_request_t *p_http_request);
void parse_req_headers(http_request_t *p_http_request);
